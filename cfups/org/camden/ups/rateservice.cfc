...
<cffunction name="getRateInformation" access="public" output="false" returnType="query">
	...
	<cfargument name="includeNegotiatedRates" type="boolean" required="false" default="false">
...
<RatingServiceSelectionRequest xml:lang="en-US">
	...
	<Shipment>
		...
		<cfif structKeyExists(arguments, "includeNegotiatedRates") and arguments.includeNegotiatedRates>
        <RateInformation>
