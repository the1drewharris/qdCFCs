<cfcomponent hint="I handle all of the newsletter functions">
	...
	<cffunction name="scheduletosend" access="public" output="false" returntype="void" hint="I schedule a newsletter to send to a later date">
		...
		<cfargument name="site" type="string" required="false" default="qdcms.com" hint="site where scheduled task should run">
		<cfschedule action="update" operation="HTTPRequest" task="#arguments.taskname#" url="http://#arguments.site#/marketing/newsletter/actions/sendemail.cfm?site=#arguments.ds#&from=#arguments.myusername#" startdate="#arguments.startdate#" starttime="#arguments.starttime#" interval="once" requesttimeout="1000">
	</cffunction>
	...
	<cffunction name="sendnewsletter" access="public" returntype="String" hint="I send newsletter">
		...
		<cfif arguments.toemail EQ "0">
			<cfset arguments.senddate=timenow>
		...
		<cfloop query="myqueue">
			...
			<cfif arguments.toemail EQ "0">
				...
				<cfinvoke component="newsletter" method="setAsSent" ds="#arguments.ds#" newsletterid="#thisnewsletter.NEWSLETTERID#">
			<cfelse>
	...
	<cffunction name="compileEmail" access="public" output="true" returntype="string" hint="I compile email address for a newsletter">
		<cfargument name="ds" type="string" required="true" hint="I am the datasource for the newsletter">
		<cfargument name="newsletterid" type="String" required="true" hint="I am newsletterid">
		...
		<cfif listfindnocase(emailtypes,"hemail") GT 0>
			...
			<cfloop query="hemails">
				<cfset email=Trim(hemail)>
				<cfset result=objtextconversions.isEmail(email)>
				<cfif result>
					<cfif refind(email,emaillist) EQ 0>
						<cfset emaillist=listAppend(emaillist,'#NAMEID#:#email#')>
					</cfif>
				</cfif>
			</cfloop>
		</cfif>
