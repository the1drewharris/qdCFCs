...
<cfcomponent displayname="usps" output="false">
	...
	<cffunction name="intlRateV2" access="public" returntype="xml" output="false" hint="Returns international rates from the USPS RateV2 API">
		<cfargument name="userid" type="String" required="true">
		<cfargument name="Country" type="string" required="true">
		<cfargument name="Pounds" type="String" required="true">
		<cfargument name="Size" type="String" required="false" default="Regular">
		<cfargument name="Ounces" type="String" required="false" default="0">
		<cfargument name="valueofContents" type="string" required="false" default="0">
		<cfargument name="Container" type="String" required="false" default="RECTANGULAR">
		<cfargument name="secureURL" type="Boolean" required="false" default="false">
		<cfargument name="productionURL" type="Boolean" required="false" default="true">
		<cfargument name="commercialFlag" type="string" required="false" default="Y">
		<cfargument name="MailType" type="String" required="false" default="">
		<cfargument name="Width" type="String" required="false" default="1">
		<cfargument name="Length" type="String" required="false" default="1">
		<cfargument name="Height" type="String" required="false" default="1">
		<cfargument name="Girth" type="String" required="false" default="">
		<cfargument name="Machinable" type="String" required="false" default="true">
		...
		<cfscript>
			var func = prepFunc(arguments.productionURL, arguments.secureURL);
			func.api = 'intlRateV2';
			func.xml = '<IntlRateV2Request USERID="#arguments.userid#">
					<Package ID="1">
						<Service>#arguments.Service#</Service>
