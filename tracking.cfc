<cfcomponent hint="I handle all the user tracking">
	...
	<cffunction  name="getDashStreams" access="public" returntype="query" hint="I add a dashboard stream for actions committed inside of qdcms">
		<cfargument name="ds" type="string" required="true" hint="I am the datasource">
		<cfargument name="maxrows" required="false" default="10">
		<cfset var getStreams=0>
		<cfquery name="getStreams" datasource="#arguments.ds#" maxrows="#arguments.maxrows#">
		SELECT 
			TIMEDATE,
			STREAM
		FROM
	...
	<cffunction name="addVisit" access="public" returntype="void" hint="I add a visit record">
		...
		<cfargument name="ignoreFormVars" type="string" required="false" default="0" hint="1 if you want this to not add form vars">
		<cfargument name="ignoreurlVars" type="string" required="false" default="0" hint="1 if you want this to not add url vars">
		...
		<cfif arguments.ignoreFormVars neq 1>
		...
		<cfif arguments.ignoreurlVars neq 1>
		...
		TIMEDATE,
		ACT,
		<cfif arguments.ignoreurlVars neq 1>VARURL,</cfif>
		<cfif arguments.ignoreFormVars neq 1>VARFORM,</cfif>
		VURL,
		SITEID)
		VALUES
		...
		<cfif arguments.ignoreurlVars neq 1><cfqueryparam value="#variables.varurl#">,</cfif>
		<cfif arguments.ignoreFormVars neq 1><cfqueryparam value="#variables.varform#">,</cfif>
