...
<!--
ul li.parentitem {
	list-style-image:url(http://spiderwebmaster.net/images/folder.gif);
	font-weight:bold;
	cursor:help;
	text-decoration:none;
}
###attributes.divname# li a:hover { text-decoration: underline overline; }
//-->
</style>
...
<li class="parentitem"><cfif Len(selectable) and selectable><input type="#SelectType#" name="#attributes.name#" value="#value#" <cfif CheckStatus eq "Checked">checked</cfif>> </cfif><a title="click to expand tree" id="Tree_#attributes.name#_#CurrentRow#" onclick="expandBranch('Tree_#attributes.name#_#CurrentRow#_Child')"><img src="http://spiderwebmaster.net/images/plus.gif" border="0" />&nbsp;<span class="#itemclass#">#display#</span></a></li>
<ul id="Tree_#attributes.name#_#CurrentRow#_Child" style="display:none;">
<cfelse>
	<li><cfif (Not Len(selectable)) OR selectable><input type="#SelectType#" name="#attributes.name#" value="#value#" <cfif CheckStatus eq "Checked">checked</cfif>></cfif><cfif Len(Img)><img src="#Img#" border="0" alt="#Display#"></cfif>&nbsp;<span class="#itemclass#">#Display#</span></li><!--- <a href="#href#">#display#</a> --->
</cfif>
