...
CREATE TABLE `menu_mnu` (
  `id_mnu` int(10) NOT NULL auto_increment,
  `idmnu_mnu` int(10) default '0',
  `label_mnu` varchar(50) NOT NULL default '',
  `tooltip_mnu` varchar(100) NOT NULL default '',
  `order_mnu` int(10) default NULL,
  `visible_mnu` int(2) default NULL,
  `url_value_mnu` varchar(100) NOT NULL default '',
...
INSERT INTO `menu_mnu` VALUES (1, NULL, 'Home', 'Home page', 1, 1, 'home', '_self');
INSERT INTO `menu_mnu` VALUES (2, NULL, 'Spring Pack', 'Products in MX Spring Pack 2006', 2, 1, 'spring', '_self');
INSERT INTO `menu_mnu` VALUES (3, NULL, 'Company', 'Company', 3, 1, '', '_self');
INSERT INTO `menu_mnu` VALUES (4, 2, 'MX RSS Reader-Writer', 'MX RSS Reader-Writer', 4, 1, 'prod&id_prd=1', '_self');
INSERT INTO `menu_mnu` VALUES (5, 2, 'MX Site Search', 'MX Site Search', 5, 1, 'prod&id_prd=2', '_self');
INSERT INTO `menu_mnu` VALUES (6, 2, 'MX Looper', 'MX Looper', 6, 1, 'prod&id_prd=3', '_self');
INSERT INTO `menu_mnu` VALUES (7, 2, 'MX Dynamic Table Sorter', 'MX Dynamic Table Sorter', 7, 1, 'prod&id_prd=4', '_self');
INSERT INTO `menu_mnu` VALUES (8, 2, 'MX Calendar', 'MX Calendar', 8, 1, 'prod&id_prd=5', '_self');
INSERT INTO `menu_mnu` VALUES (9, 2, 'MX CSS Dynamic Menus', 'MX CSS Dynamic Menus', 9, 1, 'prod&id_prd=6', '_self');
INSERT INTO `menu_mnu` VALUES (10, 2, 'MX Navigation Pack', 'MX Navigation Pack', 10, 1, 'prod&id_prd=7', '_self');
INSERT INTO `menu_mnu` VALUES (11, 3, 'Overview', 'Company overview', 11, 1, 'overview', '_self');
INSERT INTO `menu_mnu` VALUES (12, 3, 'Contact', 'Contact', 12, 1, 'contact', '_self');
