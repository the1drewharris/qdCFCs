...
<link href="$mosConfig_live_site/mambots/editors/ktml/includes/ktm/core/styles/ktml.css" rel="stylesheet" type="tex
<script>
	ktml_init_object = {
...
function botKTMLEditorArea( $name, $content, $hiddenField, $width, $height, $col, $row ) {
	...
	ob_start();
		$ktml_obj1 = new ktml4($hiddenField, "../mambots/editors/ktml/", dirname(__FILE__));
