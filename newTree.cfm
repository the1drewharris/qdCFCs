...
<li class="parentitem"><cfif Len(selectable) and selectable><input type="#SelectType#" name="#attributes.name#" value="#value#" <cfif CheckStatus eq "Checked">checked</cfif>> </cfif><a title="click to expand/collapse tree" id="Tree_#attributes.name#_#CurrentRow#" onclick="expandBranch('Tree_#attributes.name#_#CurrentRow#_Child')"><img src="http://spiderwebmaster.net/images/plus.gif" border="0" />&nbsp;<span class="#itemclass#">#display#</span></a></li>
