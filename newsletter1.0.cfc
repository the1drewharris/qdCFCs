<cfcomponent hint="I handle all of the newsletter functions">
	...
	<!--- Added by Joseph  --->
	<cffunction name="init" access="public" returntype="newsletter" hint="I run buildTables">
		<cfargument name="ds" type="string" required="true" hint="I am the dsn you want to create tables for">
		<cfinvoke component="newsletter" method="buildtables" argumentcollection="#arguments#">
		<cfreturn this>
	</cffunction>
	...
	<cffunction name="dropTables" access="public" output="false" returntype="void" hint="I drop all of the newsletter tables">
		<cfargument name="ds" type="string" required="true" hint="I am the datasource for the newsletters">
		<cfquery name="dropNewletterTables" datasource="#arguments.ds#">
		DROP TABLE NEWSLETTERTOEMAILTYPE;
		DROP TABLE NEWSLETTERVIEWED;
		DROP TABLE NEWSLETTERBOUNCED;
		DROP TABLE NEWSLETTERQUEUE;
		DROP TABLE NEWSLETTERTRACKING;
		DROP TABLE NEWSLETTERTEMPLATE;
		DROP TABLE NEWSLETTERTOUSERGROUP;
		DROP TABLE NEWSLETTER;
		</cfquery>
	</cffunction>
	
	<cffunction  name="buildTables" access="public" output="false" returntype="void" hint="I build the tables for the newsletter">
		<cfargument name="ds" type="string" required="true" hint="I am the datasource for the newsletters">
		<cfset var addNEWSLETTERTEMPLATE=0>
		<cfset var addNEWSLETTER=0>
		<cfset var addNEWSLETTERQUEUE=0>
		<cfset var addNEWSLETTERTRACKING=0>
		<cfset var addNEWSLETTERBOUNCED=0>
		<cfset var addNEWSLETTERVIEWED=0>
		
		<cfif not tblCheck.tableExists('#arguments.ds#', 'NEWSLETTERTEMPLATE')>
		<cfquery name="addNEWSLETTERTEMPLATE" datasource="#arguments.ds#">
		...
		<cfif not tblCheck.tableExists('#arguments.ds#', 'NEWSLETTER')>
		...
		<cfif not tblCheck.columnExists('#arguments.ds#', 'NEWSLETTER', 'CREATEDBYMASTERID')>
		<cfquery name="ALTERNEWSLETTERCREATEDBY" datasource="#arguments.ds#">
		ALTER TABLE NEWSLETTER ADD CREATEDBYMASTERID BIGINT 
		</cfquery>
		</cfif>
		
		<cfif not tblCheck.columnExists('#arguments.ds#', 'NEWSLETTER', 'REPLYTO')>
		<cfquery name="ALTERNEWSLETTERREPLYTO" datasource="#arguments.ds#">
		ALTER TABLE NEWSLETTER ADD REPLYTO VARCHAR(512) 
		</cfquery>
		</cfif>
		
		<cfif not tblCheck.columnExists('#arguments.ds#', 'NEWSLETTER', 'SENDFROMNAME')>
		<cfquery name="ALTERNEWSLETTERSENDFROMNAME" datasource="#arguments.ds#">
		ALTER TABLE NEWSLETTER ADD SENDFROMNAME VARCHAR(512)
		</cfquery>
		</cfif>
		
		<cfif not tblCheck.tableExists('#arguments.ds#', 'NEWSLETTERQUEUE')>
		<cfquery name="addNEWSLETTERQUEUE" datasource="#arguments.ds#">		
		...
		<cfif not tblCheck.tableExists('#arguments.ds#', 'NEWSLETTERTRACKING')>
		<cfquery name="addNEWSLETTERTRACKING" datasource="#arguments.ds#">	
		...
		<cfif not tblCheck.tableExists('#arguments.ds#', 'NEWSLETTERBOUNCED')>
		<cfquery name="addNEWSLETTERBOUNCED" datasource="#arguments.ds#">
		...
		<cfif not tblCheck.tableExists('#arguments.ds#', 'NEWSLETTERVIEWED')>
		<cfquery name="addNEWSLETTERVIEWED" datasource="#arguments.ds#">
		...
		<cfif not tblCheck.tableExists('#arguments.ds#', 'NEWSLETTERTOUSERGROUP')>
		<cfquery name="addNEWSLETTERVIEWED" datasource="#arguments.ds#">
		...
		ALTER TABLE NEWSLETTERTOUSERGROUP ADD PRIMARY KEY(NEWSLETTERID,USERGROUPID);
		...
		<cfif not tblCheck.tableExists('#arguments.ds#', 'NEWSLETTERTOEMAILTYPE')>
		<cfquery name="addNEWSLETTERTOEMAILTYPE" datasource="#arguments.ds#">
		CREATE TABLE NEWSLETTERTOEMAILTYPE
		(
			NEWSLETTERID BIGINT NOT NULL,
			EMAILTYPE VARCHAR(16) NOT NULL
		);
		ALTER TABLE NEWSLETTERTOMAILTYPE ADD CONSTRAINT PK_NEWSLETTERTOMAILTYPE PRIMARY KEY(NEWSLETTERID,EMAILTYPE);
		ALTER TABLE NEWSLETTERTOMAILTYPE ADD CONSTRAINT FK_NEWSLETTERTOEMAILTYPE_NEWSLETTER FOREIGN KEY(NEWSLETTERID) REFERENCES NEWSLETTER(NEWSLETTERID);
		</cfquery>
		</cfif>
	</cffunction>
	...
	<cffunction name="sendnewsletter" access="public" returntype="String" hint="I send newsletter">
		...
		<cfloop query="myqueue">
			...
			<cfsavecontent variable="args.viewonsitelink"><a href="http://#arguments.ds#/newsletter/#thisnewsletter.NEWSLETTERID#">http://#arguments.ds#/newsletter/#thisnewsletter.NEWSLETTERID#</a></cfsavecontent>
			...
			<cfloop list="#emaillist#" index="emailaddress">
				...
				<cfelse>
					<cfset args.fromcontact=arguments.fromaddress>
				</cfif>
				...
				<cfif len(#thisnewsletter.TEXTNEWSLETTER#) and len(#thisnewsletter.htmlnewsletter#)>
					<cfmail to="#args.contactname#<#args.senttoemail#>" from="#args.fromcontact#" replyto="#thisnewsletter.replyto#" subject="#thisnewsletter.subject#">
						...
						<html>
							...
							<!--- <img src="http://#arguments.ds#/?layout=newsletter&id=#thisnewsletter.newsletterid#&action=track&final=#newsUUID#" height="1" width="1"> --->
							</body>
						</html>
						</cfmailpart>
					</cfmail>
