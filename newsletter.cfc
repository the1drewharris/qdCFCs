<cfcomponent hint="I handle all of the newsletter functions">
	...
	<cffunction name="editEmailServer" access="public" output="false" hint="Edit email server information">
		...
		<cfargument name="username" required="false" type="string" hint="Username" default="0">
		<cfargument name="status" required="true" type="string" hint="1: Active, 0: Inactive">
		<cfargument name="password" required="false" type="string" hint="Password" default="0">
		<cfset var update=0>
		<cfquery name="update" datasource="#arguments.ds#">
			UPDATE EMAILSERVERS SET
				SERVERNAME=<cfqueryparam value="#arguments.servername#">,
				PORT=<cfqueryparam value="#arguments.port#">,
				<cfif arguments.username eq 0>
					USERNAME=0,
				<cfelse >
		...
		<cfoutput>
			...
			<cfloop query="batch">
				<cftry>
					...
					<cfset request.htmlnwltr=reReplace(nwltr.textnewsletter,'@firstname',firstname)>
					<cfset request.htmlnwltr=reReplace(request.htmlnwltr,'@lastname',lastname)>
					<cfset request.htmlnwltr=reReplace(request.htmlnwltr,'@email',senttoemail)>
					<cfif findNoCase('@pass',request.htmlnewltr)>
						...
						<cfif findpass.recordcount eq 1>
							<cfset request.htmlnwltr=reReplace(request.htmlnwltr,'@pass',findpass.pass)>
						<cfelse>
							<cfset request.htmlnwltr=reReplace(request.htmlnwltr,'@pass','password not found')>
						</cfif>
					</cfif>
					...
					<cfcatch type="any">
						...
						<cfif fileExists(filename)>
							<cffile action="append" file="#filename#" output="#e# #errorlist#">
						<cfelse>
							<cffile action="write" file="#filename#" output="#e# #errorlist#" mode="775">
						</cfif>
					</cfcatch>
				</cftry>
			</cfloop>
	...
	<cffunction name="getNoOfPeopleNotSentTo" access="public" output="false" returntype="query" hint="I get the number of people the email was sent to">
		<cfargument name="ds" required="true" type="string" hint="I am the datasource">
		<cfargument name="newsletterid" required="true" type="string" hint="I am the id for newsletter">
		<cfset var get=0>
		<cfquery name="get" datasource="#arguments.ds#">
	...
	<cffunction name="getPeopleNotSentTo" access="public" output="false" returntype="query" hint="I get the number of people the email was sent to">
		<cfargument name="ds" required="true" type="string" hint="I am the datasource">
		<cfargument name="newsletterid" required="true" type="string" hint="I am the id for newsletter">
		<cfset var get=0>
		<cfquery name="get" datasource="#arguments.ds#">
	...
	<cffunction name="getPeopleSentTo" access="public" output="false" returntype="query" hint="I get the number of people the email was sent to">
		<cfargument name="ds" required="true" type="string" hint="I am the datasource">
		<cfargument name="newsletterid" required="true" type="string" hint="I am the id for newsletter">
		<cfset var get=0>
		<cfquery name="get" datasource="#arguments.ds#">
