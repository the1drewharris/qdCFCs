...
<cfcomponent hint="I have functions for ad management">
	...
	<cffunction name="addZone" returntype="string" access="public" hint="Add an ad category and returns ADCATEGORYID">
		...
		<cfargument name="moduleid" required="false" type="string" hint="name of the module that a zone is tied to" default="1">
		<cfargument name="description" required="true" type="string" default="0" hint="height of the AD">
		<cfset var addzone=0>
	...
	<cffunction name="editRenewAd" access="public" returntype="void" hint="I edit renewad table">
		...
		<cfoutput>#arguments.check_date#</cfoutput>
	</cffunction>
